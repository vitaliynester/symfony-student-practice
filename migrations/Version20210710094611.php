 ...
 */
final class Version20210710094611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_item (id INT NOT NULL, customer_id INT NOT NULL, offer_id INT NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE cart_item ADD CONSTRAINT FK_F0FE252753C674EE FOREIGN KEY (offer_id) REFERENCES offer (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
